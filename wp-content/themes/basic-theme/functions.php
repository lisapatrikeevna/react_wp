...
add_theme_support('align-wide'); // Поддержка широких выравниваний блоков
add_theme_support('editor-styles'); // Поддержка стилей редактора
add_editor_style('editor-style.css'); // Подключение пользовательских стилей для редактора
...
function basic_theme_scripts()
{
	...
	wp_style_add_data('basic-theme-style', 'rtl', 'replace');

	wp_enqueue_script('basic-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true);
